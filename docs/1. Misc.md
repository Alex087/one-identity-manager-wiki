...
> 
>
> # 3) Создание Person в БД (Designer - Table – Person - Central
>
> Account)**
>
> '\$CustomProperty01\$
...
> And CStr(\$Firstname\$) \<\> "" And CStr(\$Middlename\$) \<\> "" And
> \_
>
...
>  
>
> <https://t-oneim-4.sgp.ru/AppServer/api/entity/Department/30002471>
>
>  
>
...
Dim email As String = login + "<@surgut.gazprom.ru>"
...
Dim adlogin As String = login + "<@sgp.ru>"
...
"<https://t-oneim-4.sgp.ru/AppServer/api/entities/Person?lastname=Тестовый4&limit=2>"
-WebSession \$wsession
...
"<https://t-oneim-4.sgp.ru/AppServer/api/entity/Person>" -WebSession
...
\$newURI = (Invoke-RestMethod -Uri
"<https://t-oneim-4.sgp.ru/AppServer/api/entity/Person/8b93c671-fafb-466b-9148-ad0d340c310e>"
...
Invoke-RestMethod -Uri
"<https://t-oneim-4.sgp.ru/AppServer/auth/logout>" -WebSession
